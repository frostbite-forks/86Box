...
const cpu_family_t cpu_families[] = {
  // clang-format off
    ...
    /* ---- Pentium III (Coppermine) – Slot 1 ---- */
    {
        ...
        .internal_name = "pentium3_coppermine_slot1",
        .cpus          = (const CPU[]) {
            {
                .name               = "500E",
                .cpu_type           = CPU_PENTIUM3,
    ...
    /* ---- Pentium III (Coppermine) – Socket 370 ---- */
    {
        ...
        .manufacturer  = "Intel",
        .name          = "Pentium III (Coppermine)",
        .internal_name = "pentium3_coppermine_fc370",
        .cpus          = (const CPU[]) {
            {
                .name               = "500E",
                .cpu_type           = CPU_PENTIUM3,
     ...
     * CPUID = 06Bxh (Family 6, Model 11 = 0Bh)
     * Stepping 1 (B1) is the primary production stepping per the Spec Update.
     * 512 KB on-die ATC L2, 8-way set associative, 256-bit wide bus, full speed.
     * 133 MHz system bus (AGTL, not AGTL+). FC-PGA2 package.
     * VCC_CORE: 1.45–1.50 V typ (VID table, Intel Order Number 249657 Table 3).
     * No Processor Serial Number (PSN) feature. */
    {
        .package       = CPU_PKG_SOCKET370,
        .manufacturer  = "Intel",
        ...
        .cpus          = (const CPU[]) {
            {
                ...
                .cache_read_cycles  = 34,
                .cache_write_cycles = 34,
                .atclk_div          = 34
            },
            {
                .name               = "1266",
                ...
                .cpu_flags          = CPU_SUPPORTS_DYNAREC | CPU_REQUIRES_DYNAREC | CPU_FIXED_MULTIPLIER,
                .mem_read_cycles    = 114,
                .mem_write_cycles   = 114,
                .cache_read_cycles  = 38,
                .cache_write_cycles = 38,
                .atclk_div          = 38
            },
            {
                .name               = "1400",
                ...
                .cpu_flags          = CPU_SUPPORTS_DYNAREC | CPU_REQUIRES_DYNAREC | CPU_FIXED_MULTIPLIER,
                .mem_read_cycles    = 126,
                .mem_write_cycles   = 126,
                .cache_read_cycles  = 42,
                .cache_write_cycles = 42,
                .atclk_div          = 42
            },
            { .name = "", 0 }
        }
